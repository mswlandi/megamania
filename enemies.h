...
// This moves the enemies according to the level's velocity
void Enemies_Move(TYPE_LEVEL level, TYPE_ENEMIES enemies[MAXENEMIES], int sizeArray, float dtime, float *number);
// This function sets which enemies will shoot in one given frame
...
// This function returns the ammount of current enemies's fires on the screen.
